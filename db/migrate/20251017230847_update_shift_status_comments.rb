...
class UpdateShiftStatusComments < ActiveRecord::Migration[7.1]
  def up
    ...
    change_column_comment :monthly_summaries, :status, from: 'draft, submitted, approved, rejected',
                                                       to: 'draft, submitted'
  end
  ...
  def down
    ...
    change_column_comment :monthly_summaries, :status, from: 'draft, submitted',
